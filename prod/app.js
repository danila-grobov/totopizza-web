...
app.use('/assets',express__WEBPACK_IMPORTED_MODULE_0___default.a.static(path__WEBPACK_IMPORTED_MODULE_1___default.a.join(__dirname + '\\assets')));

app.get("/", (_, response) =>
    response.sendFile(path__WEBPACK_IMPORTED_MODULE_1___default.a.join(__dirname + '\\index.html'))
);
